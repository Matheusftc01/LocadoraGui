...
public class guiTodosCarros extends JPanel{
	    JTable table; 
	    ListaEncCarro listCar;
	    Jbotao voltar;
	    Container c;
		CardLayout card;
		
		String[] columnNames = { "Placa", "Modelo", "Descrição","Observação","Ano","Disponivel","Km","Taxa-Diaria","Taxa-por-Km" }; 
		String[][] data;
		
		JScrollPane scroll;
	  
	    public guiTodosCarros(ListaEncCarro listCar) {
	        ...
	        this.data = listCar.ShowCarrosStruct();
	    ...
	    public void atualizaTable() {
	    	this.remove(scroll);
	    	this.data = this.listCar.ShowCarrosStruct();
